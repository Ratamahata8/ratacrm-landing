...
export const site = {
  ...
  telegram:{title:'Бесплатные разборы продолжаются в Telegram',description:'Канал — примеры и полезные материалы. Бот — конкретные туториалы и гайды.',channelLabel:'Telegram-канал',channelUrl:'https://t.me/neurovideo_ratamult',botLabel:'Открыть бота',botUrl:'https://t.me/ratamahata_bot'},
  faq:[
